...
public:
    ...
    void setDeleteChildren(bool newValue=true){ bDeleteChildren = newValue; }
  ...
  virtual ofRectangle getBoundsGlobal() { return ofRectangle(toGlobal(ofVec3f(0.0f)), getGlobalWidth(), getGlobalHeight()); }
